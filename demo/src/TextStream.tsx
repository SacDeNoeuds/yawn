export function TextStream() {
  const stream = makeFakeReadableStream(
    "Hello, this is a text stream demo using Yawn. Enjoy watching the text appear character by character!",
  )
